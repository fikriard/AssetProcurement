            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    return `<button type="button" class="btn btn-info" data-toggle="modal" data-placement="top" title="Detail" data-target="#DetailModal" onclick="getsubmission('${row['assetCode']}')"><i class="bi-info-square-fill"></i></button>
                     ...
                     <button type="button" class="btn btn-success" data-toggle="modal" data-placement="top" title="Approve"  onclick="Approve('${row['assetCode']}')" ><i class="bi-check-square"></i></button>`;
                }
            }
        ]
    });
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        console.log(result);
                            ...
                            window.location.href = "/Submission/GetAdmin"
                    }).fail((error) => {
                        console.log(error);
                    })
                },
